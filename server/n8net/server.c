...
__PYX_EXTERN_C int add(int, int); /*proto*/
__PYX_EXTERN_C int subtract(int, int); /*proto*/
...
int add(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
...
int subtract(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
